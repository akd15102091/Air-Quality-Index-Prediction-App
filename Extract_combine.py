...
def met_data(month,year) :
    ...
    length = len(finalD)
    #print(finalD[0])    #['Day', 'T', 'TM', 'Tm', 'SLP', 'H', 'PP', 'VV', 'V', 'VM', 'VG', 'RA', 'SN', 'TS', 'FG']
    #print(finalD[length-1])    #['Monthly means and totals:', '\xa0', '23.2', '31.6', '15.9', '1011.7', '59.7', '10.67', '2.1', '9.1', '18.8', '\xa0', '0', '0', '1']
    finalD.pop(length - 1)
    finalD.pop(0)
